    ...
    <div className="h-screen flex justify-center items-center">
        <div className="relative w-[500px] h-[600px] shadow-2xl rounded-[50px] flex justify-center">
            ...
            <div className="w-[400px] h-[397px] mt-[134px] mb-[69px] flex flex-col items-center gap-[35px]">
                ...
                <div className="mt-[135px] w-[370px] flex justify-between">
                    <button className="w-[150px] h-[62px] flex justify-center rounded-full items-center text-[36px] font-bold text-white bg-green-400">
                        Login
                    </button>
                    <Link to={"/register"} className="w-[170px] h-[62px] flex justify-center rounded-full items-center text-[36px] font-bold border-solid border-[1px] border-black">
                        Register
                    </Link>
                </div>
            </div>
